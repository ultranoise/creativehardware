...
martes 9 - Introducción: ¿herramientas creativas? Entornos para no matar la creatividad. Intro a Circuit Python. Ejercicios con sensores y librerias. Deberes: pensar en un ejercicio de clase (que no tenga que ver con el aprendizaje de hardware) e implementarlo con Circuit Python. 
